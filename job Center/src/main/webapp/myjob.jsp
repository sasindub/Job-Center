<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%! ResultSet rs = null;
    	%>
    <% 
    String user = (String)session.getAttribute("user"); //assign user session to user 
    rs = Model.getmyjob(user); // assign result set%> 

<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Job Center | MYJOBS </title>
<!-- CSS only -->
...
<body>
  ...
  <div class="container">
    <a class="navbar-brand" href="#" style="font-size: 20pt;">MY JOBS</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav" style="margin-left:110
      0px;">
    
        <a class="nav-link" href="job.jsp">All jobs</a>
      </div>
    </div>
  </div>
</nav>
	...
	<% 
	//get all details related to the user
	while(rs.next()) {%>
